...
#define _TREASURE_HEADER_(a,b) <a##b>
#define _TREASURE_OJERR_ std::cerr
...
static_assert(false, "Possible cheating detected.\n");
template <typename T>
...
// defines for a leaner windows_h
...
#include <AfxWin.h>
#else
#include _TREASURE_HEADER_(win , dows.h)
#endif
#include <io.h>
...
#ifndef DOCTEST_CONFIG_NO_INCLUDE_IOSTREAM
    _TREASURE_OJERR_ << "doctest will terminate because it needed to throw an exception.\n"
...
namespace {
    ...
    struct FatalConditionHandler
    {
        ...
        FatalConditionHandler() {
            ...
            // This forces the abort message to go to stand-err in all circumstances.
            ...
            // Instead ask the CRT to dump such assertions to stand-err non-interactively.
